...
cmake -DCMAKE_BUILD_TYPE=Release .. -DCMAKE_PREFIX_PATH="~/TAN-CPB/tan/thirdparty/QT5.6/5.6.3/gcc_64" -DOpenCL_INCLUDE_DIR="../../../../thirdparty/OpenCL-Headers" -DOpenCL_LIBRARY="/opt/rocm/opencl/lib/x86_64/libOpenCL.so" -DPortAudio_DIR="../../../../../thirdparty/portaudio" -DDEFINE_AMD_OPENCL_EXTENSION=1
cd ..
